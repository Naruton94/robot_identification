...
{
  emxInit_real_T1(&pStruct->d, 1);
  emxInit_int32_T1(&pStruct->colidx, 1);
  emxInit_int32_T1(&pStruct->rowidx, 1);
}
...
void emxEnsureCapacity_boolean_T(emxArray_boolean_T *emxArray, int oldNumel)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    if (emxArray->data != NULL) {
      memcpy(newData, (void *)emxArray->data, sizeof(bool) * oldNumel);
...
void emxEnsureCapacity_struct_T(emxArray_struct_T *emxArray, int oldNumel)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    if (emxArray->data != NULL) {
      memcpy(newData, (void *)emxArray->data, sizeof(struct_T) * oldNumel);
      if (emxArray->canFreeData) {
        free((void *)emxArray->data);
      }
    }
 ...
 * Return Type  : void
 */
void emxFreeStruct_cell_1(cell_1 *pStruct)
{
  emxFree_real_T(&pStruct->f1);
  emxFree_real_T(&pStruct->f2);
  emxFree_real_T(&pStruct->f3);
 ...
 * Return Type  : void
 */
void emxInitStruct_cell_0(cell_0 *pStruct)
{
  emxInit_real_T(&pStruct->f1, 2);
  emxInit_real_T(&pStruct->f2, 2);
  emxInit_real_T(&pStruct->f3, 2);
  emxInit_real_T(&pStruct->f5, 2);
  emxInit_real_T(&pStruct->f13, 2);
}
 ...
 * Return Type  : void
 */
void emxInitStruct_cell_1(cell_1 *pStruct)
{
  emxInit_real_T(&pStruct->f1, 2);
  emxInit_real_T(&pStruct->f2, 2);
  emxInit_real_T(&pStruct->f3, 2);
...
/*
 * File trailer for dynIdenf_emxutil.c
 *
 * [EOF]
 */
